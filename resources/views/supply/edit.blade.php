    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Edit Penebusan BBM</h4>
            </div>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#net_price').val({{$supply->net_price}});
            $('#ppn').val({{$supply->ppn_tax}});
            $('#ppbkb').val({{$supply->ppbkb_tax}});
            $('#pph').val({{$supply->pph_tax}});
