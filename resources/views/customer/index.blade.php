...
@section('title')
    <title>Daino TL System | Pelanggan</title>
@endsection
            ...
            <div class="table-responsive">
                <table id="basic-datatables" class="display table table-sm table-bordered table-hover" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$customer->name}}</td>
                            <td {{$customer->initial_credit<0? 'style=color:red':''}}>Rp. {{$customer->initial_credit>0? number_format($customer->initial_credit): number_format($customer->initial_credit*(-1))}}</td>
                            <td>
                                <div class="row justify-content-center">
                                    ...
                                    <button onclick="return false" data-id="{{$customer->id}}" data-nama="{{$customer->name}}" class="confirmDelete btn btn-danger btn-xs">
                                        <span class="btn-label">
