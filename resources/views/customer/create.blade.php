...
@section('title')
    <title>Daino TL System | Tambah Pelanggan</title>
@endsection
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(array('route' => 'customer.store','method'=>'POST', 'spellcheck'=>"false", 'autocomplete' => 'off')) !!}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('', null, array('placeholder' => 'Nilai Piutang Awal', 'class' => 'form-control', 'id' => 'purchase', 'onchange' => 'unmaskPurchase(value)')) !!}
